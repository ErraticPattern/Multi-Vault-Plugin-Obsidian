...
- **Vault List**: Toggle indexing for specific vaults, configure custom colors and icons, remove them, or use the folder button to set a vault's location on this device.
